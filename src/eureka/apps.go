...
func Apps()  {
	...
	fmt.Println(v.AppsHashcode)
	fmt.Println(v.VersionsDelta)
	fmt.Println(v.Application[1].Name)
	fmt.Println(v.Application[1].Instance.HostName)
	fmt.Println(v.Application[1].Instance.Metadata.JmxPort)
	fmt.Println(v.Application[1].Instance.LeaseInfo.EvictionTimestamp)
	fmt.Println(v.Application[1].Instance.DataCenterInfo.Name)
